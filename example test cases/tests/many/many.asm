...
str16: .asciiz "\nFor byte, the output should be: 16909059 in decimal, and you have:"	#at 0x005001ac, end finally at 0x00500210
...
############################################
	...
	addi $a0, $t0, 0		#read from the file to the dynamic data section
	addi $a1, $t1, 0
	addi $a2, $zero, 41
	addi $v0, $zero, 14
	syscall
